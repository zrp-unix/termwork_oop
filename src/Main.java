    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < shape_num; i++) {
            ...
            switch (shape) {
                ...
                case "Circle":
                    System.out.print("Enter the coordinates: ");
                    point = new Point2D(new double[] {in.nextDouble(), in.nextDouble()});
            ...
            String shape = in.next();
                ...
                switch (move) {
                    case "Shift":
                        ...
                        shp.add(sh.get(0).shift(new Point2D(new double[]{in.nextDouble(), in.nextDouble()})));
                        break;
                    case "Rotate":
                        System.out.print("Enter the rotation angle of the shape: ");
                        shp.add(sh.get(0).rot(in.nextDouble()));
                        break;
                    case "Symmetry":
                        System.out.print("Enter the axis around which the symmetry method will be performed: ");
                        shp.add(sh.get(0).symAxis(in.nextInt()));
                        break;
                }
                for (int k = 0; k < shape_num; k++) {
                    if (sh.get(0).cross(is.get(k))) {
                ...
                for(int k = 0; k < figure_num; k++) {
                    ...
                    switch (figure) {
                        case "Pyramid":
                            ...
                            p0 = new Point3D(new double[]{in.nextDouble(), in.nextDouble(), in.nextDouble()});
                            System.out.print("Enter the number of points at the base: ");
                            numb = in.nextInt();
                            pp = new Point3D[numb];
                            System.out.print("Enter the coordinates of the base: ");
                            for(int j = 0; j < numb; j++) {
                                pp[j] = new Point3D(new double[]{in.nextDouble(), in.nextDouble(), in.nextDouble()});
                            }
                        ...
                        case "Prism":
                            ...
                            for(int j = 0; j < numb; j++){
                                p1[j] = new Point3D(new double[]{in.nextDouble(), in.nextDouble(), in.nextDouble()});
                            }
                            System.out.print("Enter the coordinates of the top base: ");
                            for(int j = 0; j < numb; j++){
                                p2[j] = new Point3D(new double[]{in.nextDouble(), in.nextDouble(), in.nextDouble()});
                            }
